			...
			<KeyboardAwareScrollView>
				...
				{selectedProduct !== undefined &&
					<View style={{alignItems: "center"}}>
						<View>
							<IndoText style={[globalStyles.h3, {textAlign: "center"}]}>{selectedProduct.subHeader}</IndoText>
						...
						<View style={{flexDirection: "row"}} >
								<IndoText style={{flex: 1, textAlign: "center"}}>{selectedProduct.composition?.stocks} Stocks</IndoText>
								<IndoText style={{flex: 1, textAlign: "center"}}>{selectedProduct.composition?.bonds} Bonds</IndoText>
								<IndoText style={{flex: 2, textAlign: "center"}}>{selectedProduct.composition?.moneyMarketFunds} Money Market Funds</IndoText>
						</View>
					</View>
				}
				<View style={{alignItems: "center", paddingVertical: 25}}>
					<IndoButton disabled={selectedProduct === undefined} onPress={nextPage}>Make an Investment</IndoButton>
					<IndoButton color="outline-cyan">Done</IndoButton>
				</View>
			</KeyboardAwareScrollView>
		</SafeAreaView>
	);
