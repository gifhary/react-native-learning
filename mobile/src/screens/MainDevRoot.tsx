...
import {demoButtons, IDemoButtonGroup} from "../utils/devRootButtonList";
        ...
        <SafeAreaView style={globalStyles.safeArea}>
            <KeyboardAwareScrollView style={globalStyles.pagePadding}>
                ...
                <IndoText style={{fontSize: 14}}>
                    This screen can be used as a dev tool to easily access any other screen at any step in any
                    navigator.
                    {"\n"}{"\n"}
                    Some screens may appear with multiple buttons, such as the flows that can be accessed via the
                    Dashboard (ie. profile, messages, etc.)
                    {"\n"}{"\n"}
                    You can add more screens to the list in the "devRootButtonList.ts" file found in the utils
                    directory.
                </IndoText>
